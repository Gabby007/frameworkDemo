...
public class Test2 {
    ...
    public void testGetOrderById(){
        ...
        *//**
         ...
         *//*
        String statement = "com.emma.mapping.orderMapper.getOrderById";//映射sql的标识字符串
    ...
    public void testGetOrderById2(){
         ...
         */
        String statement = "com.emma.mapping.orderMapper.selectOrder";//映射sql的标识字符串
        //执行查询操作，将查询结果自动封装成Order对象返回
        Order order = sqlSession.selectOne(statement,1);//查询orders表中id为1的记录
        //使用SqlSession执行完SQL之后需要关闭SqlSession
        sqlSession.close();
   ...
   /* @Test
    public void testGetOrderById3(){
        ...
        *//**
         ...
         *//*
        String statement = "com.emma.mapping.orderMapper.selectOrderResultMap";//映射sql的标识字符串
        //执行查询操作，将查询结果自动封装成Order对象返回
        Order order = sqlSession.selectOne(statement,1);//查询orders表中id为1的记录
        //使用SqlSession执行完SQL之后需要关闭SqlSession
        sqlSession.close();
