...
public class TestCRUDByXmlMapper {
	 ...
	 @Test
	    public void testAdd(){
	         ...
	         */
	        String statement = "com.emma.mapping.userMapper.addUser";//映射sql的标识字符串
	        User user = new User();
	        user.setNice_name("emma");
	        user.setUser_name("张琦");
	        user.setAge(20);
	        //执行插入操作
	    ...
	    public void testUpdate(){
	         ...
	         */
	        String statement = "com.emma.mapping.userMapper.updateUser";//映射sql的标识字符串
	        User user = new User();
	        user.setId(3);
	    ...
	    public void testDelete(){
	         ...
	         */
	        String statement = "com.emma.mapping.userMapper.deleteUser";//映射sql的标识字符串
	        //执行删除操作
	    ...
	    public void testGetAll(){
	         ...
	         */
	        String statement = "com.emma.mapping.userMapper.getAllUsers";//映射sql的标识字符串
